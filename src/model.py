"""Small transformer with swappable positional encoding and attention mask.

The PE axis is the novel one: NoPE is known to win for *causal* attention
(Kazemnejad et al. 2023), and the usual explanation credits the causal mask with
supplying implicit position. Masked diffusion has no causal mask, so the ranking
